    ...
    public function __construct($name = null)
    {
        ...
        $this
            ...
            ->addOption(
                ...
                's',
                InputOption::VALUE_REQUIRED,
                'File to use for maintaining session (base URLs, ' .
                'consumer key, secret and user access token, secret) ' .
                'accross invocations of the command line client'
            );
    }
    ...
    protected function execute(InputInterface $in, OutputInterface $out)
    {
        ...
        if ($consumerSecret) {
            ...
            if ('' == $consumer->getSecret() &&
                isset($defaults['consumer-secret'])) {
